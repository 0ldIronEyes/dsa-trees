...
class BinaryTree {
  ...
  minDepth() {
    ...
    function minDepthHelper(node) {
      ...
      return (Max.min(minDepthHelper(node.left),minDepthHelper(node.right)))   
    }
  ...
  maxDepth() {
    ...
    function maxDepthHelper(node) {
      ...
      return (Max.max(maxDepthHelper(node.left),maxDepthHelper(node.right)))   
    }
  ...
  maxSum() {
    ...
    function maxSumHelper(node){
      ...
      result = Max.max(result, node.val + leftSum + rightSum);
